...
import { formatDate, formatDateTime, formatTime } from "./lib";
import { CenterModal } from "./Modal";

export function TaskModal({ mode, task, tags, tagsLocked, onClose, onSave, onDelete }) {
...
export function DoneDetailModal({
  task,
  tag,
  onClose,
  onRestore,
